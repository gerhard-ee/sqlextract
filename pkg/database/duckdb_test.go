...
func setupTestDuckDB(t *testing.T) *DuckDB {
...
func TestDuckDB_GetTableSchema(t *testing.T) {
	db := setupTestDuckDB(t)
	defer db.Close()
...
func TestDuckDB_GetTotalRows(t *testing.T) {
	db := setupTestDuckDB(t)
	defer db.Close()
...
func TestDuckDB_ExtractBatch(t *testing.T) {
	db := setupTestDuckDB(t)
	defer db.Close()
...
func TestDuckDB_GetPrimaryKey(t *testing.T) {
	db := setupTestDuckDB(t)
	defer db.Close()
